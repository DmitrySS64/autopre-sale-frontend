...
const AuthorizationPage = () => {
    ...
    return (
        <div className={'w-full h-full flex justify-center items-center p-5 overflow-y-auto max-lg:items-start'}>
            <div className={'w-[750px] h-fit bg-white text-black rounded-[15px] px-[100px] py-[50px] flex flex-col gap-[100px] items-center'}>
                <Logo/>
                <Tabs {...tabsData} className={'w-full flex flex-col gap-[50px]'}/>
            </div>
        </div>
    )
}
